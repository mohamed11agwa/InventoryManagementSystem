...
namespace Inventory.Infrastructure.Migrations
{
    ...
    [Migration("20260826200145_EnforceProductQuantityAndUnitPriceNotAcceptNegativeValues")]
    partial class EnforceProductQuantityAndUnitPriceNotAcceptNegativeValues
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Inventory.Domain.Inventory.StockAdjustment", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Inventory.Domain.Orders.OrderItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("OrderId", "ProductId", "WarehouseId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Inventory.Domain.Orders.OrderStatusHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Inventory.Domain.Inventory.StockAdjustment", b =>
                {
                    b.HasOne("Inventory.Domain.Inventory.Inventory", null)
            ...
            modelBuilder.Entity("Inventory.Domain.Orders.Order", b =>
                {
                    b.HasOne("Inventory.Domain.Customers.Customer", null)
                        .WithMany()
