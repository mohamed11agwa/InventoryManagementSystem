...
public sealed class AddProductToWarehouseCommandHandler(IAppDbContext context)
    : IRequestHandler<AddProductToWarehouseCommand, Result<InventoryDto>>
{
    public async Task<Result<InventoryDto>> Handle(
        AddProductToWarehouseCommand command,
        CancellationToken ct)
    {
                ...
                ct))
        {
            return Error.Conflict(
                ...
                "The product is already available in this warehouse.");
        }
